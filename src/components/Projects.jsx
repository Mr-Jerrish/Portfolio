...
const demoProjects = [
  ...
  },
  {
    ...
    liveUrl:
      "https://ai-chatbox-gc73qdj8q-sheikmohamedanzarm-7103s-projects.vercel.app",
    repoUrl: "https://github.com/Mr-Jerrish/ai-chatbox",
  },
  {
    id: 3,
    title: "Expense Tracker AI (MERN SaaS Platform)",
    desc: "A full-stack AI-powered Expense Tracker SaaS application built using React, Node.js, Express.js, and MongoDB with JWT authentication, AI financial insights, Excel export, dashboard analytics, and year-wise/month-wise/day-wise expense tracking.",
    tech: [
      "React",
      "Tailwind CSS",
      "Node.js",
    ...
    liveUrl: "https://xtracker-ai.vercel.app",
    repoUrl: "https://github.com/Mr-Jerrish/expense-tracker-client",
  },
];
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {p.tech.map((t) => (
                <span
                  key={t}
                  className="text-xs px-2 py-1 rounded-md bg-[rgba(255,255,255,0.02)]"
                >
                  {t}
                </span>
              ))}
